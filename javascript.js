              ...
              <div class="layui-card">
                  <div class="layui-card-body">
                    <div>
                      ...
                      <button type="button" id="deletePassword" class="layui-btn" style="position: absolute; right: 120px;top: 15px; background:#999;" > 删除密码</button>
          ...
          <div class="layui-col-md6 layui-col-sm6">
            <div class="layui-card">
              <div class="layui-card-body" style=" height: 426px;">
                ...
                <p>
                   选项 ->下载->用户代理(UA) ->填入下方黑体字符UA-在IDM新建任务，粘贴链接即可。<span style="font-weight: 600;" id="ts1">netdisk;P2SP;3.0.0.8;netdisk;11.12.3;GALAXY_S20;android-android;14.0;JSbridge4.4.0;jointBridge;1.1.0;</span>
                </p>
        ...
        var ddconfig = {
            ...
            "params": [
                ...
                ],
                {
                    ...
                    "max-overall-download-limit": "5240000",
                    "max-download-limit": "2220000",
                    "split": "16",
                    "dir": rpcDir,
                    "out": $('#curname').text(),
                    "user-agent": "netdisk;P2SP;3.0.0.8;netdisk;11.12.3;GALAXY_S20;android-android;14.0;JSbridge4.4.0;jointBridge;1.1.0;"
                }
            ]
        }
            ...
            onload: function (res) {
                if (res.status === 200) {
                    ...
                    if (res.response.result) {
                        Swal.fire({
                            title: '系统提示',
                            html: '推送成功！快去看看吧 若下载失败请检查保存文件路径有无配置，关闭您的代理下载！<br><a  href="https://ass.ass.baidassets.cn" target="_blank"style=" font-weight: 900;">作者推荐:超低价百度网盘svip出租，稳定好用！</a><br><a href="https://t.me/+B1PiSmBGPIw0MTYx" target="_blank"style=" font-weight: 900;">点击加入防失联交流群组</a>',
                            icon: 'success'
                        });
                    } else {
                        Swal.fire({
    ...
    const handleVcode = async (message) => {
        ...
        if(vcodeData?.code === 200) {
            const result = await Swal.fire({
                ...
                html: `
                    <div>${message}</div>
                    <img id="vcodeImg" src="${vcodeData.data.img}&t=${Date.now()}" style="cursor:pointer;width: 200px; height: 100px;">
        ...
        if (linkResponseData.code === 200) {
            ...
            Swal.fire({
                ...
                html: `
                    ...
                    <div><a href="https://t.me/+B1PiSmBGPIw0MTYx" target="_blank" style="font-weight: 900;">点击加入防失联交流群组</a></div>
                    <hr>
                    <div>配额信息</div>
