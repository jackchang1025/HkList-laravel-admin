...
use App\Http\Controllers\ApiParseController;
...
Route::middleware(["NeedInstall", "AutoUpdate", ])->group(function () {
    Route::prefix("/parse")->middleware("IpFilter")->group(function () {
        ...
        Route::prefix("/")->middleware(["NeedPassword"])->group(function () {
            ...
            Route::middleware([RegisterOrLoginUser::class,CheckLimit::class])->group(function (){
                Route::post("/list", [ApiParseController::class, "list"]);
